...
class NiScanningProbeInterfuse(ScanningProbeInterface):
    ...
    def on_activate(self):
        ...
        for axis in self._frequency_ranges:
            ...
            step = ScalarConstraint(default=0, bounds=(0, position.maximum - position.minimum))
    ...
    def _start_scan(self):
        try:
            ...
            with self._thread_lock_data:
                ...
                self.log.debug(f"New scan data: {self._scan_data.data}, position {self._scan_data.position_data}")
